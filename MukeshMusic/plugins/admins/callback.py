...
from MukeshMusic import YouTube, app
...
from MukeshMusic.utils.decorators.language import languageCB
from MukeshMusic.utils.formatters import seconds_to_min
from MukeshMusic.utils.inline import close_markup, stream_markup, stream_markup_timer
from MukeshMusic.utils.stream.autoclear import auto_clean
from MukeshMusic.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Mukesh.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
